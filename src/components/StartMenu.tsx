  ...
  return (
    <div className="start-menu" role="menu" aria-label="Start menu">
      ...
      <div className="start-grid" role="presentation">
        ...
        <button type="button" className="start-item" onClick={() => onOpen('browser', 'rn:chronicle')}>
          <span className="start-item-icon" aria-hidden>
            <IconGlobe size={18} className="icon-svg" />
          </span>
          <span className="start-item-body">
            <strong>Explore</strong>
            <small>Story threads · rn:chronicle</small>
          </span>
        </button>
        <button type="button" className="start-item" onClick={() => onOpen('browser', 'rn:shift')}>
          <span className="start-item-icon" aria-hidden>
            <IconGlobe size={18} className="icon-svg" />
          </span>
          <span className="start-item-body">
            <strong>Net Index</strong>
            <small>Hundreds of routes · rn:shift</small>
          </span>
        </button>
        <button type="button" className="start-item" onClick={() => onOpen('browser', 'rn:discover')}>
          <span className="start-item-icon" aria-hidden>
            <IconGauge size={18} className="icon-svg" />
          </span>
          <span className="start-item-body">
            <strong>Discovery log</strong>
            <small>rn:discover</small>
          </span>
        </button>
